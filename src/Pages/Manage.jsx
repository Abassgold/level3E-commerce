        ...
        <div className="container flex flex-col md:flex-row mx-auto mb-10">
          ...
          <div className="border-2 rounded-sm shadow-xl mx-16 mt-10 pt-10 pb-10">
            <div className="mx-16">
              ...
              <div className="flex gap-10 flex-wrap my-1">
                <div className="mt-2">
                  ...
                  <input
                    ...
                    type="text"
                    className="border rounded py-2 px-3 w-60 outline-none"
                    placeholder="Bammy"
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    className="border rounded py-2 px-3 w-60 outline-none"
                    placeholder="whatevermail@gmail.com"
                    defaultValue={email}
                  />
                </div>
              ...
              <div className="mt-8">
                ...
                <input
                  ...
                  type="password"
                  className="border rounded py-2 px-3 w-full mt-1 outline-none"
                ...
                <input
                  ...
                  type="password"
                  className="border rounded py-2 px-3 w-full mt-3 outline-none"
            ...
            <div className="mt-5 flex justify-end me-16">
              <button
                onClick={cancel}
                className="mx-4 py-2 px-10 sm:px-5 border rounded bg-white-100 hover:bg-red-500"
              >
                Cancel
              </button>
              <button
                onClick={saveChanges}
                className="py-2 px-10 sm:px-5 border rounded bg-red-600 text-white"
              >
                {" "}
                Save Changes
              </button>
